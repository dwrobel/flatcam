...
class CutoutUI:
    ...
    def __init__(self, layout, app):
        ...
        self.tool_sel_label = FCLabel('<span style="color:%s;"><b>%s</b></span>' % (self.app.theme_safe_color('indigo'), _('Cutout Tool')))
        ...
        self.param_label = FCLabel('<span style="color:%s;"><b>%s</b></span>' % (self.app.theme_safe_color('blue'), _("Tool Parameters")))
