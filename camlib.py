...
def voronoi(P):
    ...
    lineIndicesUnique = set(lineIndicesTupled)
        ...
        for i1, i2 in lineIndices_:
            connections = filter(lambda (i1_, i2_): (i1, i2) != (i1_, i2_) and
                                                    (i1 == i1_ or i1 == i2_ or
                                                     i2 == i1_ or i2 == i2_),
                                 lineIndices_)
            assert 1 <= len(connections) <= 2, (connections, (i1, i2), pIdx)
...
class Zprofile:
    ...
    def generate_polygons(self):
        xypts = array([[x[0], x[1]] for x in self.data])
        self.polygons = [Polygon(p) for p in voronoi_polygons(xypts)]
